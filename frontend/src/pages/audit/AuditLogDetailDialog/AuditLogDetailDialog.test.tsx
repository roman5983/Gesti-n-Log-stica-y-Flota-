...
describe('AuditLogDetailDialog', () => {
  ...
  it('shows before and after already formatted', () => {
    renderDialog(baseLog);
  ...
  it('hides unchanged fields until expanded', () => {
    renderDialog(baseLog);
  ...
  it('presents a creation as recorded data, without a comparison', () => {
    renderDialog({
      ...baseLog,
      action: 'CREATE',
      previousData: null,
  ...
  it('explains the actions that record no data', () => {
    renderDialog({
      ...baseLog,
