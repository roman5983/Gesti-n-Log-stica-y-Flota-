...
import { AuditLogDetailDialog } from '@/pages/audit/AuditLogDetailDialog/AuditLogDetailDialog';
import { actionColor, actionLabel, entityLabel, entityWithId } from '@/pages/audit/auditLabels/auditLabels.helpers';
import { AUDIT_ACTIONS, AUDIT_ENTITIES } from '@/pages/audit/auditLabels/auditLabels.data';
