...
import { Alert, Button, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Grid, IconButton, List, ListItem, ListItemButton, ListItemText, Stack, Typography } from '@mui/material';
...
import type { MaintenanceDetailDialogProps } from './MaintenanceDetailDialog.types';

/** Maintenance detail with attachments: upload (F-9) and open (append-only). */
export function MaintenanceDetailDialog({ maintenance, onClose, onChanged }: MaintenanceDetailDialogProps) {
