...
import { GOOGLE_MAPS_KEY } from '@/lib/google-maps';
...
export function RouteMap({
  ...
  const embedUrl = `https://www.google.com/maps/embed/v1/directions?key=${GOOGLE_MAPS_KEY}&origin=${encodeURIComponent(origin)}&destination=${encodeURIComponent(destination)}`;
